...
data = dict(
    ...
    train=dict(
        type='ExdarkDataset',
        ann_file='/data/unagi0/cui_data/light_dataset/Exdark/main/train.txt',
        img_prefix='/data/unagi0/cui_data/light_dataset/Exdark/JPEGImages/IMGS',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(
    ...
    val=dict(
        type='ExdarkDataset',
        ann_file='/data/unagi0/cui_data/light_dataset/Exdark/main/val.txt',
        img_prefix='/data/unagi0/cui_data/light_dataset/Exdark/JPEGImages/IMGS',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
...
work_dir = './work_dirs/yolov3_IAT_lol'
gpu_ids = [0]
